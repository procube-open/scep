...
- `installer/windows-msi` への `wixl` 入力ステージング
- `installer/windows-msi/installer/dist/MyTunnelApp.msi` の生成
...
cd <this-repo>
WINDOWS_USER="<reset-windows-passwordで取得したユーザー名>"
MSI_PATH="$(pwd)/installer/windows-msi/installer/dist/MyTunnelApp.msi"
